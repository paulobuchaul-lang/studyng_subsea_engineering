...
| B-030 | P1 | didática | Reescrever as 4 camadas de profundidade de cada capítulo como blocos com conteúdo próprio (hoje é um texto corrido único de 534-1202 palavras); rubrica em AUDITORIA_CONTEUDO_DIDATICA_V4.md seção 4 | Auditoria Sessão 2 | Sprints 4 a 6 |
| B-031 | P1 | didática | Reescrever individualmente o campo "why" dos 126 termos do glossário; hoje é texto idêntico repetido em todos | Auditoria Sessão 2 | Sprints 4 a 6 (ou dedicado, a decidir) |
...
| B-033 | P1 | Petrobras/Brasil | Registrar data de verificação em todo fato datado (contrato, valor, caso nomeado) nos capítulos 4, 9, 15, 17, 19, 21, 22; decidir se a verificação factual roda antes da V4.0 ou entra como V4.1 | Auditoria Sessão 2 | a decidir |
