...
| B-036 | P1 | técnico | Ativar branch protection na `main` exigindo o check `qa-governanca` (e, opcionalmente, PR obrigatório) em Settings → Branches, conforme GUIA_PUBLICACAO.md seção 5a. Sem isso, o CI roda mas não bloqueia merge (D-020) | Pedido do Paulo, Sessão 2 | ação manual do Paulo |
