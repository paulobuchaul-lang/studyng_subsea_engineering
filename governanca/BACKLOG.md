...
| B-026 | P1 | didática | Reavaliar a ementa de 24 capítulos e sua ordem contra o escopo do CLAUDE.md seção 5 e as seis fases; decidir se há capítulos a fundir, dividir ou criar. Bloqueia o mapeamento real da Trilha/medidor de profundidade da Home (hoje provisório, D-024) | D-013 | Sprint 3 (subiu de prioridade: já bloqueia UI entregue no Sprint 2) |
