...
### Sessão 1 — 07/09/2026 — Organização inicial do repositório GitHub
...
- Esqueleto técnico do Sprint 1 criado (`/src/content/`, `/src/data/`, `/src/templates/`), vazio e com README explicando a dependência de D-005 e do reenvio do zip completo da V3.
...
- D-014 registrada: nesta sessão não se criou pipeline de build nem se migrou conteúdo da V3, porque D-005 segue pendente e os 47 arquivos originais da V3 não foram reenviados (só a governança chegou). B-028 e B-029 abertos no backlog para destravar isso.
