...
- Paulo confirmou exigir também Pull Request obrigatório na `main`, não só o status check. GUIA_PUBLICACAO.md seções 4, 5 e 5a reescritas para o fluxo de branch temporária + PR pela própria tela de upload do GitHub, sem linha de comando. B-036 aberto: falta o Paulo ativar as duas opções em Settings → Branches.
